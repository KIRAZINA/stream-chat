...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(
        ...
        // Use PatternTopic to listen to all stream channels (chat:messages:*)
        container.addMessageListener(messageListenerAdapter, new PatternTopic(chatTopic().getTopic() + ":*"));
        return container;
    }
